            ...
            <Card className="max-w-4xl mx-auto bg-card/90 backdrop-blur-xl border border-white/10 shadow-xl">
                ...
                <CardContent className="space-y-6">
                    ...
                    <Card>
                        ...
                        <CardContent>
                           <p className="text-sm text-muted-foreground mb-4">Click the button below to send a password reset link to your registered email address. You will be logged out after sending the email.</p>
