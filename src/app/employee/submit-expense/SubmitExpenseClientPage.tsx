...
import { addExpenseReport } from '@/lib/firestoreService';
...
export default function SubmitExpenseClientPage({ initialReports }: SubmitExpenseClientPageProps) {
        ...
        <div className="container mx-auto py-8 space-y-8">
            <Card className="bg-card/90 backdrop-blur-xl border border-white/10 shadow-xl hover:shadow-primary/20 hover:-translate-y-1 transition-all duration-300">
                <CardHeader>
                    ...
                    <CardDescription>Upload a receipt and fill out the report. The AI assistant will attempt to pre-fill the form for you.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
