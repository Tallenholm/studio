    ...
    <div className="container mx-auto py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl mx-auto">
        <Link href="/pre-trip" passHref>
          <Card className="bg-card/90 backdrop-blur-xl border border-white/10 shadow-xl hover:shadow-primary/20 hover:scale-105 transition-all duration-300 h-full flex flex-col items-center justify-center text-center p-8 cursor-pointer">
