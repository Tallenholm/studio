...
export default function PersonalDocumentsClientPage({ initialDocuments }: PersonalDocumentsClientPageProps) {
  const [documents] = useState<ManagedDocument[]>(initialDocuments);
