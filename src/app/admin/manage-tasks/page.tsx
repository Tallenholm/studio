...
export default function ManageTasksPage() {
  ...
  const renderTaskList = (taskList: Task[], type: 'pending' | 'completed') => (
    <div className="space-y-4">
      {taskList.length > 0 ? (
        ...
        <EmptyState
          icon={ClipboardList}
          title={`No ${type} tasks`}
          message={type === 'pending' ? "All tasks completed! Good job." : "No completed tasks yet."}
        />
      )}
    </div>
  );
    ...
    <>
      <div className="container mx-auto py-8">
        <PageHeader
          ...
          description="Assign tasks to employees and track their completion."
          icon={ClipboardList}
        >
