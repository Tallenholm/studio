...
import { getJobs, addJob, updateJob, deleteJob } from '@/lib/firestoreService';
...
export default function JobManagementPage() {
  ...
  const { clients, users, fleetAssets, fetchClients, fetchUsers, fetchFleetAssets } = useAppStore();
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [toast, fetchClients, fetchUsers, fetchFleetAssets]);
